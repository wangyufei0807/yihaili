...
switch ($act) {
	...
	case 'editsql':
		...
		$sql="update `".dbpre."news` set article_name='".$_p_info['article_name']."',article_text='".$_p_info['article_text']."',article_atime='".$_p_info['article_atime']."',category_id='".$_p_info['category_id']."',article_tuijian='".$_p_info['article_tuijian']."',article_cuxiao='".$_p_info['article_cuxiao']."'".$sqlwhere." where article_id='$_g_id'";
