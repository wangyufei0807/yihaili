<? if (!class_exists('template')) die('Access Denied');$template->getInstance()->check('default/index/news/news.html', '8e91cd30bf8b5ca33cb1e7942b3f7520', 1354519417);?>
...
<div id="list_right">
	...
	<div class="list_right_t2"><a href="/">首页</a>&nbsp;&gt;&nbsp;<a href="/index.php?mod=news">新闻动态</a>&nbsp;&gt;&nbsp;<a href="/index.php?mod=news&amp;act=list&amp;type=<?=$fenlei['category_id']?>"><?=$fenlei['category_name']?></a></div>
	<div class="list_right_t3"><?=$info['article_name']?></div>
	<div class="list_right_t4"><?=$info['article_text']?></div>
</div>
<!--列表right-->
