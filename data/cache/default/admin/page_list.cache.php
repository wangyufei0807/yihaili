<? if (!class_exists('template')) die('Access Denied');$template->getInstance()->check('default/admin/page_list.html', 'b0a56f19c9554eb7dd33548eeb4773d9', 1354521240);?>
...
<div class="right fr">
	<div class="now">
		...
		<div class="fl now2">
			<span class="fl">业务体系列表</span>
			<span class="fr fabu mat8"><a href="admin.php?mod=page&amp;act=add">增加业务</a></span>
		</div>
	...
	<tr>
		...
		<td align="center"><a href="/index.php?mod=fwzl&amp;id=<?=$v['id']?>" target="_blank"><?=$v['name']?></a></td>
		<td align="center">
			<a href="admin.php?mod=page&amp;act=edit&amp;id=<?=$v['id']?>" class="admin_edit">修改</a>
			<a href="admin.php?mod=page&amp;act=delsql&amp;id=<?=$v['id']?>" class="admin_del" onclick="return pe_cfone('删除')">删除</a>
		</td>
	</tr><? } } ?><tr>
		<td class="bgtt" align="center"><input type="checkbox" name="checkall" onclick="pe_checkall(this, 'id')" /></td>
		<td class="bgtt" colspan="6">
			<span class="fl"><button href="admin.php?mod=page&amp;act=delsql" onclick="return pe_cfall(this, 'id', 'form', '批量删除')">批量删除</button></span>
