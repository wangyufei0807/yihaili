<? if (!class_exists('template')) die('Access Denied');$template->getInstance()->check('default/admin/category_list.html', 'ef26822fa1236e6fd93355c0974501c7', 1435572447);?>
...
<div class="right fr">
	<div class="now">
		...
		<div class="fl now2">
			<span class="fl"><? if($type=='article') { ?>文章分类<? } else { ?>产品分类<? } ?></span>
