<? if (!class_exists('template')) die('Access Denied');$template->getInstance()->check('default/admin/parent/list.html', '666aa25729a956985ae4da389f46bf64', 1354521912);?>
...
<div class="right fr">
	<div class="now">
		...
		<div class="fl now2">
			...
			<span class="fr fabu mat8"><a href="admin.php?mod=parent&amp;act=add">增加</a></span>
		</div>
	...
	<tr>
		...
		<td align="center"><? if($v['logo']!='') { ?><span class="cred">[图]</span><? } ?><a href="/index.php?mod=parent&amp;id=<?=$v['id']?>" target="_blank"><?=$v['name']?></a></td>
		<td align="center">
			<a href="admin.php?mod=parent&amp;act=edit&amp;id=<?=$v['id']?>" class="admin_edit">修改</a>
			<a href="admin.php?mod=parent&amp;act=delsql&amp;id=<?=$v['id']?>" class="admin_del" onclick="return pe_cfone('删除')">删除</a>
		</td>
	</tr><? } } ?><tr>
		<td class="bgtt" align="center"><input type="checkbox" name="checkall" onclick="pe_checkall(this, 'id')" /></td>
		<td class="bgtt" colspan="6">
			<span class="fl"><button href="admin.php?mod=parent&amp;act=delsql" onclick="return pe_cfall(this, 'id', 'form', '批量删除')">批量删除</button></span>
