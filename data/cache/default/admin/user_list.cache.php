<? if (!class_exists('template')) die('Access Denied');$template->getInstance()->check('default/admin/user_list.html', 'b1873f9c5ed07f02b995993cc91979fa', 1354518268);?>
...
<div class="right fr">
	...
	<tr>
		...
		<td class="bgtt" align="center" width="200">常用邮箱</td>
		<td class="bgtt" align="center" width="100">注册时间</td>
		<td class="bgtt" align="center" width="100">上次登录</td>
		...
		<td align="center"><?=$v['user_ltime']?></td>
		<td align="center">
